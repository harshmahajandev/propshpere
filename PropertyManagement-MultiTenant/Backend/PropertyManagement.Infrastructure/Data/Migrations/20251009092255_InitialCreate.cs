        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertiesPurchased = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Customers_Users_LinkedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Island = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Address = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Latitude = table.Column<double>(type: "float", nullable: true),
                    Longitude = table.Column<double>(type: "float", nullable: true),
                    Amenities = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Images = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FloorPlans = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyInterest = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PropertyUnits_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_Leads_LeadId",
                        column: x => x.LeadId,
                        principalTable: "Leads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Companies",
                columns: new[] { "Id", "Address", "City", "CompanyCode", "CompanyName", "ContactEmail", "ContactPhone", "Country", "CreatedAt", "Description", "Industry", "IsActive", "IsDeleted", "MaxProperties", "MaxUsers", "SubscriptionEndDate", "SubscriptionPlan", "SubscriptionStartDate", "UpdatedAt" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), null, "Manama", "DEMO2024", "Demo Real Estate Company", "demo@realestate.com", "+973-1234-5678", "Bahrain", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Demo company for testing the multi-tenant property management system", "Real Estate", true, false, 500, 20, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Professional", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_LinkedUserId",
                table: "Customers",
                column: "LinkedUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyUnits_CompanyId",
                table: "PropertyUnits",
                column: "CompanyId");
