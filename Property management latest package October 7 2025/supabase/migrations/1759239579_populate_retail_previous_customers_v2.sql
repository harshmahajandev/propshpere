-- Migration: populate_retail_previous_customers_v2
-- Created at: 1759239579
...
-- Additional prospects and leads (using customer role for now)
(gen_random_uuid(), 'ahmed.new@prospects.bh', 'Ahmed Mohammed Al-Baker', '+973-3111-2222', 'customer', 'Baker Trading Co.', 'Bahraini',
 '{"budget_range": "280000-380000", "preferred_location": "Al Naseem", "property_type": "family_villa", "bedrooms": 4, "new_inquiry": true, "stage": "lead"}',
 'New inquiry from website, interested in family villa with modern amenities', 'medium', 680, NOW() - INTERVAL '3 days'),

(gen_random_uuid(), 'sara.prospect@leads.com', 'Sara Khalil Al-Zayani', '+973-3222-3333', 'customer', 'Zayani Group', 'Bahraini',
 '{"budget_range": "320000-450000", "preferred_location": "Al Bareh", "property_type": "premium_villa", "bedrooms": 5, "corporate_inquiry": true, "stage": "lead"}',
 'Corporate executive interested in premium villa for senior management housing', 'low', 720, NOW() - INTERVAL '1 day'),

(gen_random_uuid(), 'khalid.hot@prospects.bh', 'Khalid Hassan Al-Mahmoud', '+973-3333-4444', 'customer', 'Independent Investor', 'Bahraini',
 '{"budget_range": "200000-300000", "preferred_location": "North Islands", "property_type": "investment_villa", "bedrooms": 3, "hot_lead": true, "stage": "prospect"}',
